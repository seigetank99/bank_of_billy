...
public class RegisterController {
    ...
    public ModelAndView register(@Valid @ModelAttribute("registerUser")User user,
        ...
        ModelAndView regristrationPage = new ModelAndView("register");

        //Check For Errors
        if(result.hasErrors() && confirm_password.isEmpty()){
            regristrationPage.addObject("confirm_pass", "The confirm field is required");
            return regristrationPage;
        }
